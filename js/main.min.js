...
function project() {
  ...
  const tabsContentRU = {
    1: `<div class="projects__tabs-card">
		...
		<div class="projects__tabs-card">
			...
			<h1>\u041E\u0442\u043A\u0440\u044B\u0442\u0438\u0435 \u0433\u0438\u043F\u0435\u0440\u043C\u0430\u0440\u043A\u0435\u0442\u0430 \u0432 \u0433\u043E\u0440\u043E\u0434\u0435 \u0410\u0441\u0430\u043D \u0441 \u043F\u043B\u043E\u0449\u0430\u0434\u044C\u044E 1000 \u043C\xB2</h1>
		</div>`,
  ...
  const tabsContentEN = {
    1: `<div class="projects__tabs-card">
						...
						<div class="projects__tabs-card">
							...
							<h1>Opening of a Hypermarket in Asan with an area of 1000 m\xB2</h1>
						</div>`,
    2: `<div class="projects__tabs-card">
							<picture>
								<source srcset="./images/project-2.avif" />
  ...
  tabs.forEach((tab) => {
    tab.addEventListener("click", () => {
      ...
      tabsInner.innerHTML = currentLang === "kr" ? tabsContentKR[target] : currentLang === "en" ? tabsContentEN[target] : tabsContentRU[target] || "\u041F\u0443\u0441\u0442\u043E";
    });
  });
}
